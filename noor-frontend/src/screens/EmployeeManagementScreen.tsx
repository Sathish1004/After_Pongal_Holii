...
const EmployeeManagementScreen = ({ navigation, route }: any) => {
  ...
  const { mode, taskId, taskName, projectName, phaseName } =
    route?.params || {};
    ...
    try {
      ...
      if (response.data.task && response.data.task.assignments) {
        setAssignedEmployeeIds(
          response.data.task.assignments.map((a: any) => a.id),
        );
      }
    } catch (error) {
    ...
    >
      ...
      <View style={styles.header}>
        ...
        <Text style={styles.headerTitle}>
          {isAssignmentMode ? "Assign Employee" : "Details Of Employees"}
        </Text>
        {!isAssignmentMode && (
        ...
        >
          {employees.map((emp) => (
            <TouchableOpacity
              ...
              style={styles.card}
              onPress={() =>
                navigation.navigate("WorkerDetail", { workerId: emp.id })
              }
              activeOpacity={0.7}
            >
              <View style={styles.cardHeader}>
                <View style={styles.avatar}>
                  {emp.profile_image ? (
                    <Image
                      source={{
                        uri: `${api.defaults.baseURL?.replace("/api", "")}${emp.profile_image}`,
                      }}
                      style={{
                        width: "100%",
                        height: "100%",
                  ...
                  <TouchableOpacity
                    style={[
                      ...
                      assignedEmployeeIds.includes(emp.id)
                        ? styles.assignedBtnActive
                        : styles.assignBtnInactive,
                    ]}
            ...
            <ScrollView>
              ...
              <View style={styles.row}>
                <TouchableOpacity
                  style={[
                    styles.radioBtn,
                    role === "employee" && styles.radioBtnActive,
                  ]}
                ...
                >
                  <Text
                    style={[
                      styles.radioText,
                      role === "employee" && styles.radioTextActive,
                    ]}
                  >
                    Employee
                  </Text>
                ...
                <TouchableOpacity
                  style={[
                    styles.radioBtn,
                    role === "admin" && styles.radioBtnActive,
                  ]}
                ...
                >
                  <Text
                    style={[
                      styles.radioText,
                      role === "admin" && styles.radioTextActive,
                    ]}
                  >
                    Admin
                  </Text>
              ...
              <View style={styles.row}>
                <TouchableOpacity
                  style={[
                    styles.radioBtn,
                    status === "Active" && styles.radioBtnActive,
                  ]}
                ...
                >
                  <Text
                    style={[
                      styles.radioText,
                      status === "Active" && styles.radioTextActive,
                    ]}
                  >
                    Active
                  </Text>
                ...
                <TouchableOpacity
                  style={[
                    styles.radioBtn,
                    status === "Inactive" && styles.radioBtnActive,
                  ]}
                ...
                >
                  <Text
                    style={[
                      styles.radioText,
                      status === "Inactive" && styles.radioTextActive,
                    ]}
                  >
                    Inactive
                  </Text>
