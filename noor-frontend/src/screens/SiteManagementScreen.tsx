...
const SiteManagementScreen = ({ navigation, route }: any) => {
  ...
  const handleCreate = async () => {
    ...
    try {
      ...
      Alert.alert(
        "Success",
        "Site created with default phases:\n• Planning & Site Preparation\n• Foundation\n• Structure\n• Finishing",
      );
    } catch (error) {
        ...
        {sites.length === 0 ? (
          <View style={styles.empty}>
            ...
            <Text style={styles.emptySub}>
              Tap "+ New Site" to add your first site
            </Text>
          </View>
        ) : (
          sites.map((site) => (
              ...
              <View style={styles.cardHeader}>
                ...
                <View
                  style={[
                    ...
                    {
                      backgroundColor:
                        site.status === "active" ? "#dcfce7" : "#fef3c7",
                    },
                  ]}
                >
                  <Text
                    style={[
                      styles.badgeText,
                      {
                        color: site.status === "active" ? "#16a34a" : "#d97706",
                      },
                    ]}
                  >
...
const styles = StyleSheet.create({
  ...
  content: { flex: 1 },
  contentPadding: { padding: 16, paddingBottom: 0 },
