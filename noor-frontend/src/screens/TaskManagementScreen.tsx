            ...
            return (
              <View key={task.id} style={styles.taskCard}>
                ...
                <View style={styles.metaRow}>
                  {task.site_name && (
                    <Text style={styles.meta}>📍 {task.site_name}</Text>
                  )}
                  {task.phase_name && (
                    <Text style={styles.meta}>🔧 {task.phase_name}</Text>
                  )}
                </View>
                <View style={styles.metaRow}>
                  {task.employee_name && (
                    <Text style={styles.meta}>👷 {task.employee_name}</Text>
                  )}
                ...
                <View style={styles.selectList}>
                  {sites.map((site) => (
                    <TouchableOpacity
                      ...
                      style={[
                        styles.selectItem,
                        formData.siteId === String(site.id) &&
                  ...
                  <View style={styles.selectList}>
                    {phases.map((phase) => (
                      <TouchableOpacity
                        ...
                        style={[
                          styles.selectItem,
                          formData.phaseId === String(phase.id) &&
                            styles.selectItemActive,
                        ]}
                        onPress={() =>
                          setFormData({
                ...
                <View style={styles.selectList}>
                  {employees.map((emp) => (
                    <TouchableOpacity
                      ...
                      style={[
                        styles.selectItem,
                        formData.employeeId === String(emp.id) &&
                          styles.selectItemActive,
                      ]}
                      onPress={() =>
                        setFormData({ ...formData, employeeId: String(emp.id) })
                      }
                    >
                      <Text
                        style={[
              ...
              <View style={styles.row}>
                ...
                <View style={[styles.field, { flex: 1, marginLeft: 8 }]}>
                  ...
                  <TextInput
                    ...
                    onChangeText={(t) =>
                      setFormData({ ...formData, dueDate: t })
                    }
                  />
                </View>
              </View>
