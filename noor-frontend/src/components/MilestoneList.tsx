        ...
        {milestones.length === 0 ? (
          <View style={styles.emptyContainer}>
            <Text style={styles.emptyText}>
              No milestones set. Add one to track high-level progress.
            </Text>
          </View>
        ) : (
          milestones.map((milestone) => {
            ...
            if (derivedStatus === "Started")
              progressColorStyle = { backgroundColor: "#3B82F6" }; // Blue
            if (isCompleted)
              progressColorStyle = { backgroundColor: "#10B981" }; // Green
            ...
            return (
              ...
              >
                ...
                <View style={styles.dateContainer}>
                  <Ionicons
                    name={
                      isCompleted ? "checkmark-done-circle" : "calendar-outline"
                    }
                    size={12}
                  ...
                  <Text
                    style={[
                      styles.dateText,
                      isCompleted && { color: "#047857", fontWeight: "600" },
                    ]}
                  >
                    {isCompleted
